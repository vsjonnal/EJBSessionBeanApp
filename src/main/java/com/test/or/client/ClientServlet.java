...
import com.test.or.beans.TimeoutDDSLS;
...
public class ClientServlet extends HttpServlet {
    ...
    //String jndiName = "java:global.mavenproject2-1.0-SNAPSHOT.TimeoutDDSLSBean!com.test.or.beans.TimeoutDDSLS";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            tds = (TimeoutDDSLS) obj;
            out.println("<p>Status Object before expiry : " + tds.getTimerStatus() + "</p>");
    ...
    private String testTimerDI() {
        ...
        try {
            ...
            System.out.println("Status Object after expiry : " + tds.getTimerStatus());
            System.out.println("Timer Handle Info: " + tds.getTimerHandleInfo());
